...
import { createReport, deleteReport, downloadReport, getReportSummary, listReports } from '../controllers/reports.controller.js';
...
router.delete('/:id', requireAuth, requireRole(ROLES.SUPER_ADMIN), deleteReport);
